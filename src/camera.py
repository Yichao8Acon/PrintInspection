...
class Camera(QObject):
    ...
    def main(self):
        ...
        # Set capture mode. 0 for continuous 1 2
        ...
        # Configure camera callback function on trigger
    ...
    def GrabCallback(self, hCamera, pRawData, pFrameHead, pContext):
        ...
        self.isWaiting = True
        # Notify worker class for frame ready signal
        self.frameReadyEvent.emit(hCamera)
